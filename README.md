...
- [huggingface/smolagents](https://github.com/huggingface/smolagents) - 🤗 smolagents: a barebones library for agents. Agents write python code to call tools and orchestrate other agents. (2 days ago)
- [beeradmoore/dlss-swapper](https://github.com/beeradmoore/dlss-swapper) -  (5 days ago)
